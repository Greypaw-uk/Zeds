...
namespace Zeds.BuildingLogic
{
    public class Tent : Building
    {
        public static void SmallTent()
        {
            ...
            smallTent.Position.X = Engine.Engine.ScreenWidth / 2 - smallTent.Texture.Width / 2;
            smallTent.Position.Y = Engine.Engine.ScreenHeight / 2 - 100 - smallTent.Texture.Height / 2;
